...
import UserProfileCard from '../UserProfileCard/Profile';
const Home = ({handleLogout }) => {
    // const responseData = props.location.state?.responseData;
    // console.log('llf',props);
    ...
    return (
        <div>
            ...
            <div className="container-fluid">
                ...
                <div className="row img-container mt-2">
                    <div className="col-3">
                        <div className="card color-dark imgbox">
                            <img src={image} alt="dfa" className=' img-fluid' />
                        </div>
                    </div>
                    <div className="col-3">
                        <div className="card color-dark imgbox ">
                            <img src="https://www.aljazeera.com/wp-content/uploads/2021/01/SANJAY-JAISWAL.jpg?w=640&resize=640%2C480&quality=80" alt="" className=' img-fluid'/>
                        </div>
                    </div>
                    <div className="col-3">
                        <div className="card color-dark imgbox">
                            <img src="https://www.aljazeera.com/wp-content/uploads/2021/01/AP_19067415873533.jpg?w=770&resize=770%2C513&quality=80" alt="" className=' img-fluid'/>
                    ...
                    <div className="col-3">
                        <div className="card color-dark imgbox">
                            <img src="
                https://www.aljazeera.com/wp-content/uploads/2021/01/AP_19067399243229.jpg?w=770&resize=770%2C498&quality=80" alt="" className=' img-fluid' />
